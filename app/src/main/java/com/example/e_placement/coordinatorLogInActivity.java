...
public class coordinatorLogInActivity extends AppCompatActivity {
    ...
    private static final String TAG = "coordinatorLogInActivity";


    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.coordinatorlogin_activity);

        LoginBtn = (Button) findViewById(R.id.logIn_coord);
        RegisterBtn = (Button) findViewById(R.id.Register_coord);
        ...
        RegisterBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(getApplicationContext(), coordinatorRegistration.class);
                startActivity(i);
            }
        });
    ...
    protected void onStart() {
        ...
        if(userProfile.getCurrentUser() != null){
            ...
            Toast.makeText(getApplicationContext(), "you can log in", Toast.LENGTH_SHORT).show();
