...
public class coordinatorRegistration extends AppCompatActivity {
    ...
    private String TAG = "coordinatorRegistration";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coordinator_registration);
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(first_Name)){
                    ...
                    registerUser(first_Name, middle_Name, last_Name, emailtxt, contact_no, facultytxt, pass);
    ...
    //register user
    private void registerUser(String first_Name, String middle_Name, String last_Name, String emailtxt, String contact_no, String facultytxt, String pass){
        FirebaseAuth auth = FirebaseAuth.getInstance();


        auth.createUserWithEmailAndPassword(emailtxt,pass).addOnCompleteListener(coordinatorRegistration.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    FirebaseUser firebaseUser = auth.getCurrentUser();

                    ReadWriteUserDetails writeUserDetails = new ReadWriteUserDetails(first_Name, middle_Name, last_Name, emailtxt, contact_no, facultytxt);
                    DatabaseReference refProfile = FirebaseDatabase.getInstance().getReference("coordinator");
                    ...
                    refProfile.child(firebaseUser.getUid()).setValue(writeUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(coordinatorRegistration.this, "User registered successfully", Toast.LENGTH_LONG).show();

                            }else{

                                Toast.makeText(coordinatorRegistration.this, "User registered failed. Try again.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
                    ...
                    try{
                        ...
                        Toast.makeText(coordinatorRegistration.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
